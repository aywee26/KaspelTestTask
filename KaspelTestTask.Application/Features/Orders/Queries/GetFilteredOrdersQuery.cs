...
public class GetFilteredOrdersQueryHandler : IRequestHandler<GetFilteredOrdersQuery, IEnumerable<OrderDto>>
{
    private readonly IOrdersRepository _ordersRepository;
    private readonly IMapper _mapper;

    public GetFilteredOrdersQueryHandler(IOrdersRepository ordersRepository, IMapper mapper)
    {
